...
#print "Main Character Races Sounds Imported"
#
...
#
#print "About to imporr anm_Conv"
#execfile("../../Scripts/anm_conv.py")
#print "anm_Conv imported"
...
# PJ Init
#
print "About to Exec pj.py"
execfile("pj.py")
print "pj.py Executed"
...
print "Over with BladeInitHollow.py"