...
Bladex.SetActionEventTable("Ena","g_08","ATTACKING")
Bladex.SetActionEventTable("Ena","g_01","ATTACKING")
Bladex.SetActionEventTable("Ena","g_02","ATTACKING")
Bladex.SetActionEventTable("Ena","g_05","ATTACKING")
Bladex.SetActionEventTable("Ena","g_06","ATTACKING")
Bladex.SetActionEventTable("Ena","g_07","ATTACKING")
Bladex.SetActionEventTable("Ena","g_09","ATTACKING")
Bladex.SetActionEventTable("Ena","g_18","ATTACKING")
Bladex.SetActionEventTable("Ena","g_15","ATTACKING")
Bladex.SetActionEventTable("Ena","g_14","ATTACKING")
Bladex.SetActionEventTable("Ena","g_13","ATTACKING")
Bladex.SetActionEventTable("Ena","g_16","ATTACKING")
Bladex.SetActionEventTable("Ena","g_11","ATTACKING")
Bladex.SetActionEventTable("Ena","g_12","ATTACKING")
Bladex.SetActionEventTable("Ena","g_17","ATTACKING")
Bladex.SetActionEventTable("Ena","g_21","ATTACKING")
Bladex.SetActionEventTable("Ena","g_22","ATTACKING")
Bladex.SetActionEventTable("Ena","g_23","ATTACKING")
Bladex.SetActionEventTable("Ena","g_26","ATTACKING")
Bladex.SetActionEventTable("Ena","g_27","ATTACKING")
Bladex.SetActionEventTable("Ena","g_31","ATTACKING")

# Predeclare & link all my dodges into DODGES action event tables
Bladex.SetActionEventTable("Ena","D_r", "DODGING")
Bladex.SetActionEventTable("Ena","D_l", "DODGING")
Bladex.SetActionEventTable("Ena","D_b", "DODGING")
